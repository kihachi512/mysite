  ...
  const getFallbackResponse = (userMessage: string): string => {
    ...
    if (message.includes('こんにちは') || message.includes('こんばんは') || message.includes('おはよう') || message.includes('はじめまして') || message.includes('やっほー') || message.includes('よろしく')) {
      ...
      if (message.includes('おはよう') || isEarlyMorning) {
        ...
        timeGreetings = [
          'こんにちはー！☀️ お昼の時間だねー！僕、さっきまで天井の梁でお昼寝してたんだ〜💤 ふわぁ...まだ眠いかも。午後の陽だまりって最高だよね〜✨',
          ...
          'こんにちはー！君もお昼休み？😋 僕は365日休憩中だけどね〜♪ えへへ、いいでしょ？自由気ままなモモンガライフ！🐿️'
        ]
      } else if (isEvening) {
        timeGreetings = [
        ...
        timeGreetings = [
          'やっほー！🙋‍♂️ 僕、モモンガだよ〜！でもみんな「モモンガくん」って呼んでくれるの。なんか可愛らしくて気に入ってるんだ😊 君はなんて呼んでほしい？',
    ...
    if (message.includes('ありがとう') || message.includes('感謝')) {
      const thanksResponses = [
        ...
        'ありがとうって言われると、尻尾がフワフワ〜ってしちゃうー🐿️✨ 嬉しすぎて天井まで飛び跳ねたくなっちゃう！',
